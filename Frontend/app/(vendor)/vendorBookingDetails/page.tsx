            ...
            <tbody>
              {bookingDetails.map((event, index) => (
                <tr key={index}>
                  ...
                  <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{event.eventName}</td>
                  ...
                  <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                    <span className={event.status === 'Pending' ? 'text-blue-500' : 'text-green-500'}>{event.status}</span>
                  </td>
                  <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{event.paymentStatus}</td>
                </tr>
              ))}
            </tbody>
          </table>
